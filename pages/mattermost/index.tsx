  ...
  return (
    <Container>
      ...
      <Grid margin={2}>
        ...
        <Typography paragraph={true}>
          プロフィール写真の設定や、 チャンネル入退出の通知についてなど、 興味がありましたら是非ご一読ください。
        </Typography>
        <hr />
        ...
        <Typography paragraph={true}>
          Mattermost のアイコンはデジコアと同じものが自動でセットされます。 Mattermost
          に登録する前に、デジコアのアイコンをセットすることをおすすめします。
        </Typography>
        <Typography paragraph={true}>
          <Link href="/user/profile">デジコアのプロフィール編集はこちら</Link>
        </Typography>
        <Typography paragraph={true}>
          上記の説明をご確認いただけましたら、 下のボタンを押してデジクリMattermostへの登録を始めてください。
        </Typography>
        <Typography paragraph={true}>
          <FormGroup>
            <FormControlLabel
        ...
        <Typography paragraph={true} align="center">
          <Button variant="contained" disabled={!agree} href="/mattermost/register">
            Mattermost への登録を開始
          </Button>
        </Typography>
      </Grid>
