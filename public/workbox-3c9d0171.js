define(["exports"], function (t) {
  ...
  class a {
    ...
    addFetchListener() {
      self.addEventListener("fetch", (t) => {
        const { request: e } = t,
          s = this.handleRequest({ event: t, request: e });
        s && t.respondWith(s);
      });
    }
    addCacheListener() {
          ...
          const { payload: e } = t.data,
            s = Promise.all(
              e.urlsToCache.map((e) => {
                ...
                return this.handleRequest({ event: t, request: s });
              }),
            );
    ...
    handleRequest({ request: t, event: e }) {
      ...
      let c;
      try {
        c = a.handle({ event: e, params: r, request: t, url: s });
      } catch (t) {
        c = Promise.reject(t);
      }
      ...
      return (
        c instanceof Promise &&
          ...
          (c = c.catch(async (n) => {
            if (h)
              try {
                return await h.handle({ event: e, params: r, request: t, url: s });
              } catch (t) {
                t instanceof Error && (n = t);
              }
            if (this.o) return this.o.handle({ event: e, request: t, url: s });
            throw n;
          })),
        c
      );
    ...
    findMatchingRoute({ url: t, sameOrigin: e, request: s, event: n }) {
      ...
      for (const i of r) {
        let r;
        const a = i.match({ event: n, request: s, sameOrigin: e, url: t });
        if (a)
          return (
            (r = a),
    ...
    async fetch(t) {
      ...
      try {
        for (const t of this.iterateCallbacks("requestWillFetch"))
          n = await t({ event: e, request: n.clone() });
      } catch (t) {
    ...
    async getCacheKey(t, e) {
      ...
      if (!this.h[s]) {
        ...
        for (const t of this.iterateCallbacks("cacheKeyWillBeUsed"))
          n = m(await t({ event: this.event, mode: e, params: this.params, request: n }));
        this.h[s] = n;
      }
      return this.h[s];
    }
    ...
    *iterateCallbacks(t) {
    ...
    async R(t) {
      ...
      for (const t of this.iterateCallbacks("cacheWillUpdate"))
        if (
          ((e = (await t({ event: this.event, request: this.request, response: e })) || void 0),
          (s = !0),
          !e)
        )
          break;
  ...
  class R {
    ...
    handleAll(t) {
      ...
      const e = t.event,
        ...
        r = new v(this, { event: e, params: n, request: s }),
        i = this.q(r, s, e);
  ...
  class A {
    ...
    async setTimestamp(t, e) {
      const s = { cacheName: this.L, id: this.N(t), timestamp: e, url: (t = K(t)) },
    ...
    try {
      ...
      const r = (function (t) {
        ...
        a = (function (t, e, n) {
          const r = t.size;
          if ((n && n > r) || (e && e < 0))
            throw new s("range-not-satisfiable", { end: n, size: r, start: e });
          let i, a;
          return (
            void 0 !== e && void 0 !== n
              ? ((i = e), (a = n + 1))
        ...
        c = o.size,
        h = new Response(o, { headers: e.headers, status: 206, statusText: "Partial Content" });
      return (
  ...
  class Y extends R {
    ...
    async S(t, e) {
      ...
      if (!(await e.cachePut(t, n.clone())))
        throw new s("bad-precaching-response", { status: n.status, url: t.url });
      return n;
    }
    A() {
      let t = null,
    ...
    install(t) {
      return $(t, async () => {
        ...
        for (const [e, s] of this.F) {
          const n = this.$.get(s),
            r = this.H.get(e),
            i = new Request(e, { cache: r, credentials: "same-origin", integrity: n });
          await Promise.all(
            this.strategy.handleAll({ event: t, params: { cacheKey: s }, request: i }),
          );
        }
        const { updatedURLs: s, notUpdatedURLs: n } = e;
        return { notUpdatedURLs: n, updatedURLs: s };
      });
    }
    activate(t) {
      return $(t, async () => {
  ...
  ((t.CacheFirst = class extends R {
    async U(t, e) {
      ...
      if (!r) throw new s("no-response", { error: n, url: t.url });
      return r;
    }
  }),
    ...
    (t.NetworkFirst = class extends R {
      ...
      async U(t, e) {
        ...
        let i;
        if (this.tt) {
          const { id: s, promise: a } = this.et({ handler: e, logs: n, request: t });
          ((i = s), r.push(a));
        }
        const a = this.st({ handler: e, logs: n, request: t, timeoutId: i });
        r.push(a);
    ...
    (t.StaleWhileRevalidate = class extends R {
      ...
      async U(t, e) {
        ...
        if (!i) throw new s("no-response", { error: r, url: t.url });
        return i;
      }
    }),
